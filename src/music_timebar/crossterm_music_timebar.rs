...
use crate::audio_player::simple_audio_player::Timebar;

pub struct CrosstermMusicTimebar {
    state: Arc<Mutex<String>>,
    current_time: Arc<Mutex<u64>>,
}

impl Timebar for CrosstermMusicTimebar {
    fn new() -> Self {
        Self {
    ...
    fn create_bar(&self, mit: &MusicInfoTemp) {
        ...
        let duration = mit.get_duration();
        let track_title = mit.get_title();
        let bar_len = 50;
